...
{{/*
Name of the ClusterRole and ClusterRoleBinding: the fullname qualified by the
release namespace, since cluster-scoped objects from two releases would
otherwise collide. Capped at 63 like every other name.
*/}}
{{- define "stackradar-scanner.clusterRoleName" -}}
{{- printf "%s-%s" (include "stackradar-scanner.fullname" .) .Release.Namespace | trunc 63 | trimSuffix "-" }}
{{- end }}
